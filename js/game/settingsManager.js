...
export const SETTING_DEFINITIONS = {
    ...
    play_music_when_hidden: {
        ...
        hasExtraInfo: true,
        info: "Normally, when you stop actively viewing the game (e.g., switching to another tab), the game loop and audio is paused/muted. If this setting is ON, the game's music will not be paused while the game is hidden.",
        default: false,
        unlockCondition: () => true,
    },
    ...
    spreadsheet_mode: {
        ...
        overlay: "performance",
        hasExtraInfo: true,
        info: "Obliterates visual fluff, like a spreadsheet. All core logic remains the same, but many visual effects are worsened or removed. Improves game performance significantly.",
        default: false,
        unlockCondition: () => true,
    },
    graphics_quality: {
