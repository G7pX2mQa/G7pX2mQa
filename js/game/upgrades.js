...
const SURGE_PLACEHOLDER_TIES = new Set([
  UPGRADE_TIES.ENDLESS_COINS,
]);
...
function determineLockState(ctx) {
  ...
  // ==== Surge Placeholders ====
  if (SURGE_PLACEHOLDER_TIES.has(tieKey)) {
    if (getCurrentSurgeLevel() >= 3n || isUpgradePermanentlyUnlocked(area, upgRef)) {
