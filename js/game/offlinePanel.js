...
export function formatTimeCompact(ms) {
  ...
  if (msBn.cmp(bnYear) >= 0) {
    ...
    return days === 0
      ? `${formatNumber(years)}y`
      : `${formatNumber(years)}y ${days}d`;
  }
...
export const RESOURCE_REGISTRY = [
  ...
  },
  {
    ...
    baseIcon: "img/currencies/rainbow_gem.webp",
    noPlusBase: true,
    singular: "Rainbow Gem",
    plural: "Rainbow Gems",
    type: "currency",
  },
  {
    key: "coins",
    bgGradient:
      "linear-gradient(to bottom, #d1a008 0%, #e3b527 15%, #ffeb3b 50%, #e3b527 85%, #d1a008 100%)",
    icon: "img/currencies/coin/coin.webp",
    baseIcon: "img/currencies/coin/coin_plus_base.webp",
    singular: "Coin",
    plural: "Coins",
    type: "currency",
  },
  {
    ...
    bgGradient:
      "linear-gradient(to bottom, #008bcc 0%, #00aeff 15%, #00c8fa 50%, #00aeff 85%, #008bcc 100%)",
    fillGradient:
      "linear-gradient(90deg, rgba(0,240,255,1) 0%, rgba(0,150,255,1) 50%, rgba(0,70,210,1) 100%)",
    barOutline: "3px",
    borderColor: "#01060f",
    barBoxShadow:
      "inset 0 6px 10px rgba(255,255,255,0.14), inset 0 -6px 14px rgba(0,0,0,0.45)",
    glassBg:
  ...
  },
  {
    key: "books",
    bgGradient:
      "linear-gradient(to bottom, #82551b 0%, #94601e 15%, #AC6C1B 50%, #94601e 85%, #82551b 100%)",
    icon: "img/currencies/book/book.webp",
    baseIcon: "img/currencies/book/book_plus_base.webp",
    singular: "Book",
    plural: "Books",
    type: "currency",
  },
  {
    key: "gold",
    bgGradient:
      "linear-gradient(to bottom, #FF9801 0%, #FFAC15 15%, #FFC926 50%, #FFAC15 85%, #FF9801 100%)",
    icon: "img/currencies/gold/gold.webp",
    baseIcon: "img/currencies/gold/gold_plus_base.webp",
    singular: "Gold",
    plural: "Gold",
    type: "currency",
  },
  {
    ...
    fillGradient:
      "linear-gradient(90deg, rgba(255,170,0,1) 0%, rgba(255,120,0,1) 50%, rgba(200,60,0,1) 100%)",
    barOutline: "3px",
    borderColor: "#2a0b00",
    barBoxShadow:
      "inset 0 6px 10px rgba(255,192,128,0.18), inset 0 -6px 14px rgba(0,0,0,0.52)",
    glassBg:
  ...
  },
  {
    ...
    plural: "Mutations",
    type: "levelStat",
    barText: 'Mutation<span class="mp-level-value">{val}</span>',
  },
  {
    key: "magic",
    bgGradient:
      "linear-gradient(to bottom, #42138A 0%, #6A1ECF 15%, #9F30FF 50%, #6A1ECF 85%, #42138A 100%)",
    icon: "img/currencies/magic/magic.webp",
    baseIcon: "img/currencies/magic/magic_plus_base.webp",
    singular: "Magic",
    plural: "Magic",
    type: "currency",
  },
  {
    key: "gears",
    bgGradient:
      "linear-gradient(to bottom, #5c5d61 0%, #8f9096 15%, #9d9fa6 50%, #8f9096 85%, #5c5d61 100%)",
    icon: "img/currencies/gear/gear.webp",
    baseIcon: "img/currencies/gear/gear_plus_base.webp",
    singular: "Gear",
    plural: "Gears",
    type: "currency",
  },
  {
    ...
    type: "levelProg",
    pinBgGradient:
      "linear-gradient(180deg, rgba(10,30,40,1), rgba(15,40,55,1))",
    bgGradient:
      "linear-gradient(to bottom, #0286a1 0%, #02b1d4 15%, #00eded 50%, #02b1d4 85%, #0286a1 100%)",
    fillGradient:
      "linear-gradient(90deg, rgba(0,237,237,1) 0%, rgba(2,177,212,1) 50%, rgba(2,48,115,1) 100%)",
    barOutline: "3px",
    borderColor: "#023340",
    barBoxShadow:
      "inset 0 6px 10px rgba(0,237,237,0.18), inset 0 -6px 14px rgba(0,0,0,0.52)",
    glassBg:
      "linear-gradient(180deg, rgba(255,255,255,0.46), rgba(255,255,255,0))",
    glassOpacity: "0.55",
    getState: () => {
  ...
  },
  {
    ...
    baseIcon: "img/misc/surge_plus_base.webp",
    singular: "Surge",
    plural: "Surges",
    type: "levelStat",
  ...
  },
  {
    key: "dna",
    bgGradient:
      "repeating-linear-gradient(-45deg, #C00000, #C00000 30.1px, #00B0F0 30.1px, #00B0F0 60.2px)",
    icon: "img/currencies/dna/dna.webp",
    baseIcon: "img/currencies/dna/dna_plus_base.webp",
    singular: "DNA",
    plural: "DNA",
    type: "currency",
  },
  ...
  },
  {
    ...
    plural: "Levels",
    type: "levelStat",
    barText: 'Level<span class="waterwheel-level-value">{val}</span>',
  },

  {
    key: "scrap",
    bgGradient:
      "linear-gradient(to bottom, #666666 0%, #767676 15%, #8a8a8a 50%, #767676 85%, #666666 100%)",
    icon: "img/currencies/scrap/scrap.webp",
    baseIcon: "img/currencies/scrap/scrap_plus_base.webp",
    singular: "Scrap",
    plural: "Scrap",
    type: "currency",
  },
  ...
  },
  {
    key: "copper",
    bgGradient:
      "linear-gradient(to bottom, #b6673f 0%, #d1835c 15%, #e99f79 50%, #d1835c 85%, #b6673f 100%)",
  ...
  },
  {
    key: "iron",
    bgGradient:
      "linear-gradient(to bottom, #aab0b6 0%, #c9ced3 15%, #e6e8eb 50%, #c9ced3 85%, #aab0b6 100%)",
  ...
  },
  {
    key: "pure_gold",
    bgGradient:
      "linear-gradient(to bottom, #d4b22c 0%, #eecf53 15%, #ffe67a 50%, #eecf53 85%, #d4b22c 100%)",
  ...
  },
  {
    key: "diamond",
    bgGradient:
      "linear-gradient(to bottom, #50c3ca 0%, #7be0e6 15%, #a0f6f9 50%, #7be0e6 85%, #50c3ca 100%)",
  ...
  },
  {
    key: "emerald",
    bgGradient:
      "linear-gradient(to bottom, #23ab1b 0%, #47d13f 15%, #6bf564 50%, #47d13f 85%, #23ab1b 100%)",
    icon: "img/materials/emerald.webp",
    baseIcon: "img/currencies/scrap/scrap_base.webp",
    noPlusBase: true,
    singular: "Emerald",
    plural: "Emeralds",
  ...
  },
  {
    key: "ruby",
    bgGradient:
      "linear-gradient(to bottom, #c22121 0%, #e64545 15%, #ff6b6b 50%, #e64545 85%, #c22121 100%)",
    icon: "img/materials/ruby.webp",
    baseIcon: "img/currencies/scrap/scrap_base.webp",
    noPlusBase: true,
    singular: "Ruby",
    plural: "Rubies",
  ...
  },
  {
    key: "sapphire",
    bgGradient:
      "linear-gradient(to bottom, #0022cc 0%, #1c38d6 25%, #3950d4 50%, #1c38d6 75%, #0022cc 100%)",
    icon: "img/materials/sapphire.webp",
    baseIcon: "img/currencies/scrap/scrap_base.webp",
    noPlusBase: true,
    singular: "Sapphire",
    plural: "Sapphires",
  ...
  },
  {
    ...
    bgGradient:
      "linear-gradient(to bottom in oklch, #ff0000, #ff8800, #ffff00, #00ff00, #00ffff, #0000ff, #a000ff, #ff00ff)",
    icon: "img/materials/prismatium.webp",
    baseIcon: "img/currencies/scrap/scrap_base.webp",
    noPlusBase: true,
    singular: "Prismatium",
    plural: "Prismatium",
  ...
  },
  {
    ...
    bgGradient:
      "linear-gradient(to bottom, #6B4E3A 0%, #8A674D 15%, #A98060 50%, #8A674D 85%, #6B4E3A 100%)",
    fillGradient:
      "linear-gradient(90deg, rgba(169,128,96,1) 0%, rgba(138,103,77,1) 50%, rgba(107,78,58,1) 100%)",
    barOutline: "3px",
    borderColor: "#1f1610",
    barBoxShadow:
      "inset 0 6px 10px rgba(169,128,96,0.18), inset 0 -6px 14px rgba(0,0,0,0.52)",
    glassBg:
      "linear-gradient(180deg, rgba(255,255,255,0.46), rgba(255,255,255,0))",
    glassOpacity: "0.55",
    getState: () => {
      ...
      return {
        ...
        progress: state.progress,
        requirement: state.requirement,
        isUnlocked: window.dpSystem.isDpSystemUnlocked
          ? window.dpSystem.isDpSystemUnlocked()
          : true,
        ratio: window.dpSystem.getDpProgressRatio
          ? window.dpSystem.getDpProgressRatio()
          : 0,
      };
    },
  },
  {
    key: "dp_levels",
    icon: "img/stats/dp/dp.webp",
    singular: "meter of Depth",
    plural: "meters of Depth",
    type: "levelStat",
    barText: 'Depth:<span class="dp-level-value">{val}</span>m',
    noTextGap: true,
  },

  {
    key: "cores",
    bgGradient:
      "linear-gradient(to bottom, #0a0a0a 0%, #1a1a1a 15%, #2a2a2a 50%, #1a1a1a 85%, #0a0a0a 100%)",
    icon: "img/currencies/core/core.webp",
    baseIcon: "img/currencies/core/core_plus_base.webp",
    singular: "Core",
    plural: "Cores",
    type: "currency",
  },
  {
    key: "crystals",
    bgGradient:
      "linear-gradient(to bottom, #943276 0%, #bd53a3 15%, #e979d0 50%, #bd53a3 85%, #943276 100%)",
    icon: "img/currencies/crystal/crystal.webp",
    baseIcon: "img/currencies/crystal/crystal_plus_base.webp",
    singular: "Crystal",
    plural: "Crystals",
    type: "currency",
  },
  {
    ...
    fillGradient:
      "linear-gradient(90deg, rgba(239,117,178,1) 0%, rgba(235,82,159,1) 50%, rgba(232,48,140,1) 100%)",
    barOutline: "3px",
    borderColor: "#1a050d",
    barBoxShadow:
      "inset 0 6px 10px rgba(255,255,255,0.14), inset 0 -6px 14px rgba(0,0,0,0.45)",
    ...
    getState: () => {
      ...
      return {
        ...
        progress: state.progress,
        requirement: state.requirement,
        isUnlocked: window.ppSystem.isPpSystemUnlocked
          ? window.ppSystem.isPpSystemUnlocked()
          : true,
        ratio: window.ppSystem.getPpProgressRatio
          ? window.ppSystem.getPpProgressRatio()
          : 0,
      };
    },
  },
  {
    key: "pp_levels",
    icon: "img/stats/pp/pp.webp",
    singular: "atm of Pressure",
    plural: "atms of Pressure",
    type: "levelStat",
...
function applyAutoColor(plusEl, textEl, colorKey, registryConfig) {
  ...
  if (colorKey === "dna") {
    ...
    if (registryConfig && registryConfig.bgGradient) {
      const match = registryConfig.bgGradient.match(
        /(#[0-9a-fA-F]{3,8}|rgba?\([^)]+\))\s+50%/,
      );
      if (match) {
    ...
    if (
      ...
      if (baseConfig && baseConfig.bgGradient) {
        const match = baseConfig.bgGradient.match(
          /(#[0-9a-fA-F]{3,8}|rgba?\([^)]+\))\s+50%/,
        );
        if (match) {
          displayStyle = match[1];
...
export function showOfflinePanel(rewards, offlineMs, isPreAutomation = false) {
  ...
  header.textContent = isPreAutomation
    ? "Pre-Automation Offline Gift"
    : "Offline Progress";
  ...
  RESOURCE_REGISTRY.forEach((config) => {
    ...
    if (
      amountText === "Infinity" ||
      amountText === "NaN" ||
      amountText.includes("infinity-symbol")
    ) {
      hasInfinity = true;
    }
...
export function calculateOfflineRewards(seconds) {
  ...
  if (rpMult && !rpMult.isZero()) {
    ...
    const activeNodes = RESEARCH_NODES.filter((n) =>
      isResearchNodeActive(n.id),
    );
      ...
      if (loopGuard >= MAX_LOOPS) {
        ...
        if (tempRp.cmp(req) >= 0) {
          ...
          if (isLinear) {
            ...
            scaleMinus1.isZero() === false &&
            (scaleMinus1.sig > 0 || scaleMinus1.isInfinite())
          ) {
    ...
    if (Object.keys(researchProgress).length > 0)
      rewards.research_progress = researchProgress;
  }
  ...
  if (Object.keys(waterwheelData).length > 0)
    rewards.waterwheel_progress = waterwheelData;
  // -----------------------------

  const gearRate = getGearsProductionRate
    ? getGearsProductionRate()
    : BigNum.fromInt(0);
  ...
  // Books (Surge 3)
  const bookRate = getBookProductionRate
    ? getBookProductionRate()
    : BigNum.fromInt(0);
  if (!bookRate.isZero()) {
  ...
  if (isSurgeActive(13) || isSurgeActive(16) || isSurgeActive(80)) {
    ...
    if (isSurgeActive(13)) {
      ...
      if (
        xpState &&
        xpState.unlocked &&
        levelBigNumToNumber(xpState.xpLevel) >= 31
      ) {
    ...
    if (typeof sys.onOffline === "function") {
      ...
      if (rate > 0) {
        ...
        if (sys.getAmountMultiplier) {
          totalPassivesSecs = totalPassivesSecs.mulDecimal(
            String(sys.getAmountMultiplier()),
          );
        }
        totalPassivesSecs = totalPassivesSecs.mulDecimal(
          String(sysEfficiencyMult),
        );
