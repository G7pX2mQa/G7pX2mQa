...
export const RESOURCE_REGISTRY = [
    ...
    { key: 'obsidian', bgGradient: 'linear-gradient(to bottom, #232429 0%, #3c3e45 15%, #595c63 50%, #3c3e45 85%, #232429 100%)', icon: 'img/materials/obsidian.webp', baseIcon: 'img/currencies/scrap/scrap_base.webp', noPlusBase: true, singular: 'Obsidian', plural: 'Obsidian', type: 'currency' },
    { key: 'unobtainium', bgGradient: 'linear-gradient(to bottom, #661ab0 0%, #8b3dd6 15%, #ad61ff 50%, #8b3dd6 85%, #661ab0 100%)', icon: 'img/materials/unobtainium.webp', baseIcon: 'img/currencies/scrap/scrap_base.webp', noPlusBase: true, singular: 'Unobtainium', plural: 'Unobtainium', type: 'currency' },
