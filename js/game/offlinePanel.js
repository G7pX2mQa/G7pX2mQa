...
import { computeUpgradeEffects, getCurrentAreaKey as getUpgAreaKey } from "./upgrades.js";
...
export function formatTimeCompact(ms) {
    ...
    try {
        if (ms instanceof BigNum)
            s_val = ms.inf || ms.e >= BigNum.DEFAULT_PRECISION ? Infinity : Number(ms.toPlainIntegerString()) / 1000;
...
export const RESOURCE_REGISTRY = [
    ...
    {
        key: "coins",
        bgGradient: "linear-gradient(to bottom, #d1a008 0%, #e3b527 15%, #ffeb3b 50%, #e3b527 85%, #d1a008 100%)",
    ...
    {
        key: "books",
        bgGradient: "linear-gradient(to bottom, #82551b 0%, #94601e 15%, #AC6C1B 50%, #94601e 85%, #82551b 100%)",
    ...
    {
        key: "gold",
        bgGradient: "linear-gradient(to bottom, #FF9801 0%, #FFAC15 15%, #FFC926 50%, #FFAC15 85%, #FF9801 100%)",
    ...
    {
        key: "magic",
        bgGradient: "linear-gradient(to bottom, #42138A 0%, #6A1ECF 15%, #9F30FF 50%, #6A1ECF 85%, #42138A 100%)",
    ...
    {
        key: "gears",
        bgGradient: "linear-gradient(to bottom, #5c5d61 0%, #8f9096 15%, #9d9fa6 50%, #8f9096 85%, #5c5d61 100%)",
    ...
    {
        key: "scrap",
        bgGradient: "linear-gradient(to bottom, #666666 0%, #767676 15%, #8a8a8a 50%, #767676 85%, #666666 100%)",
    ...
    {
        key: "copper",
        bgGradient: "linear-gradient(to bottom, #b6673f 0%, #d1835c 15%, #e99f79 50%, #d1835c 85%, #b6673f 100%)",
    ...
    {
        key: "iron",
        bgGradient: "linear-gradient(to bottom, #aab0b6 0%, #c9ced3 15%, #e6e8eb 50%, #c9ced3 85%, #aab0b6 100%)",
    ...
    {
        key: "pure_gold",
        bgGradient: "linear-gradient(to bottom, #d4b22c 0%, #eecf53 15%, #ffe67a 50%, #eecf53 85%, #d4b22c 100%)",
    ...
    {
        key: "diamond",
        bgGradient: "linear-gradient(to bottom, #50c3ca 0%, #7be0e6 15%, #a0f6f9 50%, #7be0e6 85%, #50c3ca 100%)",
    ...
    {
        key: "emerald",
        bgGradient: "linear-gradient(to bottom, #23ab1b 0%, #47d13f 15%, #6bf564 50%, #47d13f 85%, #23ab1b 100%)",
    ...
    {
        key: "ruby",
        bgGradient: "linear-gradient(to bottom, #c22121 0%, #e64545 15%, #ff6b6b 50%, #e64545 85%, #c22121 100%)",
    ...
    {
        key: "sapphire",
        bgGradient: "linear-gradient(to bottom, #0022cc 0%, #1c38d6 25%, #3950d4 50%, #1c38d6 75%, #0022cc 100%)",
    ...
    {
        key: "unobtainium",
        bgGradient: "linear-gradient(to bottom, #330d58 0%, #7633b5 25%, #9352d8 50%, #7633b5 75%, #330d58 100%)",
...
export function showOfflinePanel(rewards, offlineMs, isPreAutomation = false, oldTotals = null) {
    ...
    RESOURCE_REGISTRY.forEach((config) => {
        ...
        setHtmlOrText(text, hasInfinity ? `${displayName}${diffText}` : `${amountText} ${displayName}${diffText}`);
        row.appendChild(plus);
        row.appendChild(icon);
        if (hasInfinity) {
...
export async function processOfflineProgress() {
    ...
    if (now < lastSave - 50000 && !IS_MOBILE) {
