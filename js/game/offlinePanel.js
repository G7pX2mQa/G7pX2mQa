...
export const RESOURCE_REGISTRY = [
    ...
    { key: 'obsidian', bgGradient: 'linear-gradient(to bottom, #111111 0%, #1e1e1e 15%, #2a2a2a 50%, #1e1e1e 85%, #111111 100%)', icon: 'img/materials/obsidian.webp', baseIcon: 'img/currencies/scrap/scrap_base.webp', noPlusBase: true, singular: 'Obsidian', plural: 'Obsidian', type: 'currency' },
