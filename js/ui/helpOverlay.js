...
const HELP_ENTRIES = [
  ...
  },
  {
    ...
    nerdModeText: `<div style="margin-bottom:12px;"><strong>Wave Requirement Formula</strong><br><code>Requirement = 10 ^ SurgeLevel</code><br>After SurgeLevel 1e12: <code>Requirement = 10 ^ (SurgeLevel + 5 * e^(2.36e-10 * (SurgeLevel - 1e12)))</code>.</div><div><strong>Base Wave Gain Formula</strong><br><code>Base Waves = Floor(10 ^ (1 + Max(0, log10(Coins) - 24) * log10(1.1) + Max(0, log10(Gold) - 13) * log10(1.1) + Max(0, log10(Magic) - 5) * log10(1.1) + Max(0, log10(CumulativeMP) - 12) * log10(1.1) + (XPLevel - 201) / 35))</code>.</div>`,
    themeClass: "is-surge",
    isVisible: () => {
