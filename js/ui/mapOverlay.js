...
export function getMapNodes() {
    return [
        ...
        { id: 'cavern', areaId: AREAS.UNDERWATER_CAVERN, name: 'Underwater Cavern', icon: 'img/misc/scrap_plus_base.webp', top: '36%', left: '75%', defaultLocked: true, previousNodeId: 'cove' },
